...
const Blog = () => {
  ...
  const fetchComment = async () => {
    try {
      const { data } = await axios.get(`/api/blog/get-blog-comments/${id}`);
  ...
  return data ? (
    <div className="relative">
      ...
      />
      <Navbar />
      <div className="text-center mt-6 lg:mt-12 md:mt-8 text-gray-600">
        <p className="text-primary py-4 font-medium">
          Dipublikasikan pada{" "}
          {Moment(data.createdAt).locale("id").format("D MMMM YYYY")}
        </p>
      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        ...
        <div className="mt-14 mb-10 max-w-3xl mx-auto">
          <p className="font-semibold mb-4">Komentar ({comment.length})</p>
        ...
        <div className="max-w-3xl mx-auto">
          <p className="font-semibold mb-4">Tambahkan komentar Anda</p>
          <form
            onSubmit={addComment}
